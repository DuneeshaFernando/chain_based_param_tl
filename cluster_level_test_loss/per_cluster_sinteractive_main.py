...
cluster_files = ['machine-3-4.csv', 'machine-3-11.csv']
mod_name = "c4"
target_configs = {'NUM_LAYERS': 5, 'WINDOW_SIZE': 19, 'HIDDEN_SIZE': 30, 'BATCH_SIZE': 128, 'LEARNING_RATE': 2.6496087886479146e-05}
...
# As the first step, read each cluster csv from the normal folder
...
# As the first step, read each cluster csv from the anomaly folder
...
with open('test_loss_results_csvs/cluster_test_loss.csv', 'w') as csv_file:
